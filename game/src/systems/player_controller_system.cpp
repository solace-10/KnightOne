...
void PlayerControllerSystem::Initialize(Pandora::Scene* pScene)
{
    ...
    m_ForwardButtonPressedToken = GetInputSystem()->AddKeyboardCallback([this]() { this->m_Thrust = ShipThrust::Forward; }, GLFW_KEY_W, KeyAction::Pressed);
    m_ForwardButtonReleasedToken = GetInputSystem()->AddKeyboardCallback([this]() { this->m_Thrust = ShipThrust::None; }, GLFW_KEY_W, KeyAction::Released);
    m_LeftButtonPressedToken = GetInputSystem()->AddKeyboardCallback([this]() { this->m_Steer = ShipSteer::Port; }, GLFW_KEY_A, KeyAction::Pressed);
    m_LeftButtonReleasedToken = GetInputSystem()->AddKeyboardCallback([this]() { this->m_Steer = ShipSteer::None; }, GLFW_KEY_A, KeyAction::Released);
    m_RightButtonPressedToken = GetInputSystem()->AddKeyboardCallback([this]() { this->m_Steer = ShipSteer::Starboard; }, GLFW_KEY_D, KeyAction::Pressed);
    m_RightButtonReleasedToken = GetInputSystem()->AddKeyboardCallback([this]() { this->m_Steer = ShipSteer::None; }, GLFW_KEY_D, KeyAction::Released);
}
