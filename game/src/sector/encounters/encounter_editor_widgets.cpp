...
void PinIconInternal(ImDrawList* drawList, const ImVec2& a, const ImVec2& b, PinIconType type, bool filled, ImU32 color, ImU32 innerColor);
...
void PinIcon(const ImVec2& size, PinIconType type, bool filled, const ImVec4& color /*= ImVec4(1, 1, 1, 1)*/, const ImVec4& innerColor /*= ImVec4(0, 0, 0, 0)*/)
{
    if (ImGui::IsRectVisible(size))
    {
        ...
        PinIconInternal(drawList, cursorPos, cursorPos + size, type, filled, ImColor(color), ImColor(innerColor));
    }
